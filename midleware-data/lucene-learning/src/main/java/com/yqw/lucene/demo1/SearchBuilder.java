...
public class SearchBuilder {
    ...
    public static void doSearch(String indexDir, String queryStr) throws IOException, org.apache.lucene.queryparser.classic.ParseException, InvalidTokenOffsetsException {
    ...
    public static void main(String[] args) {
        String indexDir = "D:\\lucene";//索引所在目录
        //String q = "内容"; //查询这个字符串
        String q = "文";
        try {
            doSearch(indexDir, q);
